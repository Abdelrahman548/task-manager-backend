...
namespace TaskManager.Service.Interfaces
{
    public interface IDepartmentService
    {
        ...
        Task<BaseResult<PagedList<EmployeeResponseDto>>> GetEmployees(Guid departmentId, ItemQueryParameters criteria);
        Task<BaseResult<PagedList<ManagerResponseDto>>> GetManagers(Guid departmentId, ItemQueryParameters criteria);
